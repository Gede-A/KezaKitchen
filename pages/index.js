...
export default function Home() {
    return (
        <Layout className="">
            <SEO
                title="KezaKitchen - A landing page"
                description="Discover KezaKitchen, the effortless way to plan your meals with the power of Notion. Streamline your nutrition journey and achieve your health goals with ease."
            />
